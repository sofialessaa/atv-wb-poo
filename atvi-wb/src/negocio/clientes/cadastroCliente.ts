...
export default class CadastroCliente extends Cadastro {
    ...
    public cadastrar(): void {
        ...
        let mesCPF = parseInt(partesDataCPF[1], 10) - 1; // Ajuste no mês
        ...
        let genero: Genero | null = null; // Inicializar como null
        do {
            ...
            if (generoString === 'M' || generoString === 'F' || generoString === 'O') {
                genero = generoString as Genero; // Convertendo string para Genero
            } else {
        ...
        while (true) {
            ...
            let mesRG = parseInt(partesDataRG[1], 10) - 1; // Ajuste no mês
